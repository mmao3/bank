...
public class UpdateProfile_ extends JFrame implements ActionListener {
	...
	public UpdateProfile_(int accountNumber) {
		setSize(600, 700);
		setVisible(true);
	...
	public void init() {
		...
		JLMiddleName.setBounds(140, 40, 80, 24);
